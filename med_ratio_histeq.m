...
for i = desired_range
    ...
    bv_fft = logfft2(bv_histeq);
    bv2_fft = logfft2(bv2_histeq);
    ...
    % mkdir(sprintf("./band_ratio_%s", dir_name.name));
    % imwrite(bv_histeq, sprintf("./band_ratio_%s/A_over_B.png", dir_name.name))
    % imwrite(bv2_histeq, sprintf("./band_ratio_%s/B_over_A.png", dir_name.name))
end
